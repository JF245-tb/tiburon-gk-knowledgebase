...
**Pull-up voltage tables:** The resistance curve above is a PT100 platinum RTD (100 Ω at 32 °F, 138.51 Ω at 212 °F). Haltech uses a **1 kΩ** pull-up, the AiM PDM 32 an internal **2 kΩ** — so the two devices need different voltage tables for the same sensor. Both columns are in `pt100-pullup-voltage-tables.md`.
