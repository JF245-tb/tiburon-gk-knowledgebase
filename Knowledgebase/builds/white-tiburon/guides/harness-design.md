...
| **Fan** | HB1 | B1 + B2 | 12 AWG | OEM fan connector or ring terminal | Firewall → RIGHT → radiator |
...
> **MP3 and MP6 repurposed** from wipers to horn and headlights. Wipers use MP9 (B4) low, MP10 (B5) high, LP9 (B3) park sweep on Grey Connector — relay-less park design, config pre-loaded.
