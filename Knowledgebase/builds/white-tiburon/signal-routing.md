...
|--------|----------|-----------|--------|------|----------|-------|
| CAN H | Haltech 26-pin pin 23 | AIM PDM (CAN1) | PDM Black Connector A30 | W (white) | ISO 11898, 500 kbps | ✅ Haltech broadcasts RPM, coolant temp, throttle, etc. |
| CAN L | Haltech 26-pin pin 24 | AIM PDM (CAN1) | PDM Black Connector A31 | L (blue) | | ✅ PDM uses CAN data for: fuel pump RPM trigger, fan temp trigger |
| CAN H (PDM → dash) | PDM Black Connector A22 | AIM 10" Dash | — | — | | ⚠️ AIM dash may daisy-chain from PDM or use its own CAN port |
...
|---------|----------|------|-------|
| **Grey Connector B23** (Ignition) | Ignition toggle switch | Latching, 12V when ON | Master PDM power state; source for `SafeIgnition`. Also spliced to Haltech 34-pin pin 13 (P, purple) — ECU IGN enable. Engine off without cutting battery. ✅ |
...
| HB1 | B1 + B2 | Fan | ECT 4-band PWM 77–92°C + Ch02 low / Ch03 high override | 100Hz; Half Bridge 35A; freewheeling diode |
...
| LP5 | A18 | Wideband | `SafeIgnition` | Innovate LM2 power (LP5 max 2A) |
