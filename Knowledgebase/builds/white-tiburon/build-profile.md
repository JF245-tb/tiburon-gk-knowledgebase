...
- **Small poles:** Jumpered from battery side large terminal. Output side → IGN toggle switch → PDM Grey Connector pin B23 (IGN input) + Haltech 34-pin pin 13 (ECU IGN enable)
...
- **Ignition switch:** Dedicated latching toggle — goes to PDM Grey Connector pin B23 (Ignition input) AND Haltech 34-pin pin 13 (ECU IGN enable). Turns engine off without cutting PDM/battery power.
