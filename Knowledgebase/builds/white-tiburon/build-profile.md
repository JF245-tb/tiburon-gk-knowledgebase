...
- **Fan override:** Latching toggle — PDM Ch10 (B22, digital-only). Forces fan to 98% duty.
- **Wiper Low:** Latching toggle — PDM Ch02 (B27). Wiper motor low speed (future).
- **Wiper High:** Latching toggle — PDM Ch03 (B28). Wiper motor high speed (future).
- **Coolsuit:** Latching toggle — PDM Ch12 (A27, digital-only). Coolsuit pump on/off.
