...
```
Read hardware/aim/aim-pdm/pdm-configuration-guide.md and help me configure the starter logic.
```
...
| `hardware/aim/aim-pdm/pdm-configuration-guide.md` | PDM output map and input configuration |
